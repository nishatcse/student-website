...
function createStudentCard(student) {
    ...
    image.src = `/student-website/images/${student.id}.jpg`;
    ...
    id.textContent = `M305${student.id}`;
    ...
    try {
        ...
        function updatePaginationButtons() {
            ...
            const filteredStudents = students.filter((student) => {
                const searchData = `${student.name} M305${student.id} ${student.school} ${student.college} ${student.hometown}`.toLowerCase();
        ...
        function filterStudents(query, students) {
            ...
            return students.filter((student) => {
                ...
                if (searchData.includes(`M305${query}`)) {
                    return true;
                }
